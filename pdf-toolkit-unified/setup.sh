...
echo ""
echo "  🌟 NEW: PDF → JSON Workflow (for databases):"
echo "     python scripts/pdf_to_clean_json.py --batch ../pdfs/ ./output/products/ --keep-md"
echo "     → Creates clean JSON files ready for database import!"
echo ""
...
echo ""
echo "DOCUMENTATION:"
echo "  QUICK_START.md              - 🌟 Start here for database workflow!"
echo "  docs/DATABASE_WORKFLOW.md   - Complete PDF → JSON guide"
echo "  docs/WORKFLOWS.md           - Step-by-step workflows"
echo "  docs/README.md              - Full script reference"
